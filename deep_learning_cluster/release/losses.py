...
def cox_ph_loss_sorted(log_h: Tensor, weights: Tensor,events: Tensor, eps: float = 1e-7,d_theta: float = 2.14) -> Tensor:
...
def cox_ph_loss(log_h: Tensor, weights: Tensor,durations: Tensor, events: Tensor, eps: float = 1e-7,d_theta: float = 2.14) -> Tensor:
    ...
    log_h = log_h[:,idx]
    weights=weights[idx,:]
    return cox_ph_loss_sorted(log_h,weights, events, eps,d_theta)
